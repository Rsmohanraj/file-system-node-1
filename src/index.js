...
app.get('/', (req, res)=>{
    ...
    res.status(200).send(`
    <h1 style="background-color:gray;padding:10px 0px;text-align:center">
...
app.get('/new-create-write-read-txt',(req, res)=>{
    ...
    try{
        ...
        res.status(200).send(`<div style="background-color:yellow;padding:10px 0px;text-align:center;color:black">
        ...
        res.status(500).send(`<h1 style="background-color:yellow;padding:10px 0px;text-align:center;color:white">
